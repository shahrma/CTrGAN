...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--use_data_filters', action='store_false', help='')

        self.parser.add_argument('--testset', type=str, default='.', help='path to images - B path.')
        self.parser.add_argument('--single_source_mode', action='store_true', help='train, val, test, etc')
